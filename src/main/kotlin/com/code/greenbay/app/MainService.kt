...
fun main() {
    ...
    vertx.deployVerticle(MainService())
        .onSuccess { println("${MainService::class.java.simpleName} deployed successfully.") }
        .onFailure { println("${MainService::class.java.simpleName} not deployed successfully.") }
    vertx.deployVerticle(AuthService())
        .onSuccess { println("${AuthService::class.java.simpleName} deployed successfully") }
        .onFailure { println("${AuthService::class.java.simpleName} not deployed successfully") }
}